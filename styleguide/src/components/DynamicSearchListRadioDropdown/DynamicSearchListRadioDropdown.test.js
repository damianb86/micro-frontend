...
import DynamicSearchListRadioDropdown from './index';
import { projectOptions } from '../../../../__test__/fixtures/common/DropdownItems';

describe('DynamicSearchListRadioDropdown', () => {
  const props = {
    items: [{ id: '2', name: 'Project 2' }],
    radioItems: [
      { name: 'jobTitle', value: 'current', label: 'Current' },
      { name: 'jobTitle', value: 'past', label: 'Past', checked: true }
    ],
  ...
  const wrapper = mount(<DynamicSearchListRadioDropdown {...props} />);
