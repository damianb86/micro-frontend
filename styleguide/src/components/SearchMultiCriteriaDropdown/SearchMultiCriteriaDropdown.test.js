...
import SearchMultiCriteriaDropdown from './index';

// Test on Desktop device
window.testMediaQueryValues = { width: 770 };

describe('SearchMultiCriteriaDropdown', () => {
  ...
  const wrapper = mount(<SearchMultiCriteriaDropdown {...props} />);
  ...
  describe('functions', () => {
    ...
    xit('should call props.onApply with the correct parameters when press the apply button', () => {
      ...
      expect(props.onApply).toHaveBeenLastCalledWith(searchItems);
    });
  });
});
